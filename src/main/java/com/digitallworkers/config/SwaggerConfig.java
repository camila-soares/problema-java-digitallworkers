...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket (DocumentationType.SWAGGER_2)
                ...
                .select ()
                .apis (RequestHandlerSelectors.basePackage ("com.digitallworkers.controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API para criação de comprovantes",
                "Esta API tem as funcionalidades de criar comprovante, listar todos comprovantes e baixar comprovante",
                "Versão 1.0",
